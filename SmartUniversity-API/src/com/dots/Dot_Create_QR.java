...
public class Dot_Create_QR implements IDot
{
	...
	{
		return "Dot_Create_QR{" + "id_enseignant=" + id_enseignant + ", code_seance='" + code_seance + '\''
				+ ", fichier=" + Arrays.toString(fichier) + ", texte_qr='" + texte_qr + '\'' + '}';
	}
}