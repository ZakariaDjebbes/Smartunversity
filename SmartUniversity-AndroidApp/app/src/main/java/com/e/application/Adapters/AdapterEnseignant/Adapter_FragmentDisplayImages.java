...
import com.e.application.Control.Enseignant.FragmentDisplayJustification;
...
public class Adapter_FragmentDisplayImages extends RecyclerView.Adapter<Adapter_FragmentDisplayImages.ViewHolder> {

    private ArrayList<Justification> mData;
    private LayoutInflater mInflater;
    private Adapter_FragmentDisplayImages.ItemClickListener mClickListener;


    // data is passed into the constructor
    public Adapter_FragmentDisplayImages(FragmentDisplayJustification context, ArrayList<Justification> justifications) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.recyclerview_display_images, parent, false);
    ...
    public void setClickListener(FragmentDisplayJustification itemClickListener) {
