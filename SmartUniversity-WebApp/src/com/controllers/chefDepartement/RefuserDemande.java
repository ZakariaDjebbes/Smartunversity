...
@WebServlet("/User/RefuserDemande")
public class RefuserDemande extends HttpServlet 
{
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		case ConsulterDemandeChefDepartement.DEMANDE_CHANGEMENT_SEANCE:
			...
			target = client.target("http://localhost:8080/SmartUniversity-API/api/update/departement/refuser/demande/changement")
		...
		case ConsulterDemandeChefDepartement.DEMANDE_SEANCE_SUPP:
			...
			target = client.target("http://localhost:8080/SmartUniversity-API/api/update/departement/refuser/demande/seanceSupp")
		...
		case ConsulterDemandeChefDepartement.DEMANDE_CONGE_ACADEMIQUE:
			DemandeCongeAcademiqueResponse demandeConge = (DemandeCongeAcademiqueResponse) session.getAttribute("demande");
			int numero_conge_academique = demandeConge.getCongeAcademique().getNumero_conge_academique();
			target = client.target("http://localhost:8080/SmartUniversity-API/api/update/departement/refuser/demande/congeAcademique")
