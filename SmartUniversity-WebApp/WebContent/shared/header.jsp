	...
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="navcol-1">
			<ul class="nav navbar-nav ml-auto">
				<li class="nav-item" role="presentation"><a class="nav-link" href="index.jsp">Acceuil</a></li>
				<li class="nav-item" role="presentation"><a class="nav-link" href="nous-contacter.jsp">Nous contacter</a></li>
				<li class="nav-item" role="presentation"><a class="nav-link" href="login.jsp">Se connecter</a></li>
				<li class="nav-item dropdown"><a class="dropdown-toggle nav-link" data-toggle="dropdown" aria-expanded="false" href="#"><img src="assets/img/Logo/french_flag.png"
					...
					<div class="dropdown-menu" role="menu">
						<a class="dropdown-item" role="presentation" href="#"><img src="assets/img/Logo/english_flag.png" style="width: 25px; margin-right: 10px;">English (EN)</a><a class="dropdown-item"
							role="presentation" href="#"><img src="assets/img/Logo/arabic_flag.png" style="width: 25px; margin-right: 10px;">Ø§ÙØ¹Ø±Ø¨ÙØ© &nbsp; &nbsp; &nbsp; (AR)</a>
					</div></li>
			</ul>
		</div>
	</div>
