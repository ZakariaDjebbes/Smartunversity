...
<title><fmt:message key="pages.index_admin.liste_module_title"></fmt:message> - NTIC</title>
						...
						<div class="card-body">
							...
							<div class="row">
								<div class="col text-center">
									<h2 class="text-success"><fmt:message key="pages.index_admin.liste_module_title"></fmt:message></h2>
									<p><fmt:message key="pages.index_admin.liste_module_subtitle"></fmt:message></p>
								</div>
							</div>
							<div class="row mt-3">
								<div class="col">
										...
										<table id="table-modules" class="table table-striped table-bordered">
											<thead>
												<tr class="table-success">
													<th><fmt:message key="pages.index_admin.code_module"></fmt:message></th>
													<th><fmt:message key="pages.index_admin.nom_module"></fmt:message></th>
